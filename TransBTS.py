...
class InitConv(nn.Module):
    def __init__(self, in_channels=2, out_channels=16, dropout=0.2):
...
#-------------------TransBTS_downsample8x_skipconnection
...
class TransformerBTS(nn.Module):
    def __init__(
        ...
        self.Unet = Unet(in_channels=self.num_channels, base_channels=16, num_classes=2)
